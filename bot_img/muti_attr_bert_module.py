...
from bot_img.run_classifier_muti_attr import InputExample, InputFeatures, convert_single_example, \
    create_model, \
    convert_examples_to_features
import bot_img.muti_configurations as cf_muti
...
if __name__ == "__main__":
    serving = MutiBertTest()
    sentence = input("sentence：")
    while sentence:
        muti_attr_result = serving.predict(sentence)
        print(muti_attr_result)
        sentence = input("sentence：")
